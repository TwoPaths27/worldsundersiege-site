// Worlds Under Siege history and origins
//
// Each card entry can contain:
// status, origin, first, period, aliases, and history.
//
// Cards without an entry remain blank in the viewer.

const lore = {

  "BOA-001": {
    status: "Legendary King (Possibly Historical)",
    origin: "Britain",
    first: "Historia Brittonum (c. 830 AD)",
    period: "5th–6th Century",
    aliases: "Arthur Pendragon; The Once and Future King",
    history: `King Arthur is a legendary king of Britain whose existence has never been conclusively proven. While many historians believe he may have been inspired by one or more real military leaders who defended Britain after the fall of the Roman Empire during the 5th or 6th century, there is no definitive historical evidence that Arthur himself existed. Over the centuries, stories about him grew into one of the greatest collections of legends in European history.

Arthur first appears in early Welsh poetry and medieval chronicles before becoming famous through Geoffrey of Monmouth's Historia Regum Britanniae ("History of the Kings of Britain"), written around 1136. Geoffrey described Arthur as a mighty king who united Britain, defeated the invading Saxons, conquered much of Europe, and ruled from his magnificent court. Although historians consider Geoffrey's account to be largely fictional, it established Arthur as Britain's greatest legendary monarch and inspired countless later writers.

During the centuries that followed, authors such as Chrétien de Troyes, Sir Thomas Malory, and many others expanded Arthur's story into the legendary cycle recognized today. They introduced beloved figures including Merlin, Queen Guinevere, Sir Lancelot, the Knights of the Round Table, Camelot, Excalibur, and the quest for the Holy Grail. Today, King Arthur remains one of the most influential figures in world mythology, representing courage, justice, leadership, and the ideal of the noble king.`
  },

  "BOA-002": {
    status: "Legendary Wizard (Possibly Inspired by History)",
    origin: "Wales and Britain",
    first: "Early Welsh Poetry (c. 10th Century)",
    period: "Arthurian Era",
    aliases: "Myrddin; Merlin Ambrosius",
    history: `Merlin is a legendary wizard from Arthurian legend whose existence has never been historically verified. He is considered a fictional character, although many scholars believe he was inspired by one or more historical Celtic druids, poets, or prophets who lived in Britain during the early Middle Ages. Through centuries of storytelling, Merlin became one of the most recognizable magicians in world literature.
...
Later medieval romances greatly expanded Merlin's role. He became Arthur's mentor, orchestrated the sword in the stone, advised the Knights of the Round Table, and was credited with magical feats such as transporting the stones of Stonehenge to England. His story ends tragically when he falls in love with the enchantress Nimue—also called Viviane or the Lady of the Lake—who eventually imprisons him forever using the very magic he taught her. Merlin remains one of the greatest symbols of wisdom, prophecy, and ancient magic in Western mythology.`
  ...
  "BOA-003": {
    ...
    first: "Erec and Enide (c. 1170 AD)",
    period: "Arthurian Era",
    aliases: "Lancelot du Lac; Lancelot of the Lake; Launcelot",
    history: `Sir Lancelot is a legendary knight of the Round Table and one of the most famous heroes in Arthurian literature. Unlike King Arthur and Merlin, Lancelot does not appear in the earliest Welsh traditions or chronicles about Arthur. He was introduced into the Arthurian world by the French poet Chrétien de Troyes during the 12th century and later became known as Arthur's greatest and most skilled knight.

Lancelot received his first major role in Chrétien de Troyes' romance Lancelot, the Knight of the Cart, written during the late 12th century. In the story, Queen Guinevere is abducted by the knight Meleagant, and Lancelot endures humiliation, danger, and imprisonment in order to rescue her. The romance also established his secret love for Guinevere, a relationship that would become one of the most important—and ultimately destructive—parts of the Arthurian legend. 
...
After Arthur's kingdom falls, Lancelot abandons warfare and spends the remainder of his life in repentance as a monk or holy man. His story represents both the highest ideals and the deepest failures of knighthood: he is Arthur's greatest warrior, but his forbidden love helps destroy the kingdom he swore to protect.`
  ...
  "BOA-004": {
    ...
    first: "Owain, or the Lady of the Fountain (c. 1150 AD)",
    period: "Arthurian Era",
    aliases: "Sir Yvain; Owain; Yvain, Knight of the Lion",
    history: `Sir Yvain, known in Welsh tradition as Owain, is one of the legendary Knights of the Round Table and one of the greatest heroes of Arthurian legend. He first appeared in the Welsh romance Owain, or the Lady of the Fountain before becoming famous throughout Europe in Chrétien de Troyes' French romance Yvain, the Knight of the Lion, written around 1180. His adventures focus on honor, redemption, and the balance between knightly glory and personal responsibility.
...
"BOA-005": {
    status: "Legendary Knight (Fictional)",
    origin: "French Arthurian Romance",
    first: "Lancelot-Grail Cycle (Early 13th Century)",
    period: "Arthurian Era",
    aliases: "Sir Galahad; Galahad the Pure",
    history: `Sir Galahad is the legendary son of Sir Lancelot and is considered the purest and most virtuous of all the Knights of the Round Table. Unlike many Arthurian heroes, Galahad was created during the early 13th century as part of the French Lancelot-Grail Cycle. He was introduced as the perfect Christian knight, destined to accomplish what no other knight could achieve—the discovery of the Holy Grail.

According to the legends, Galahad was raised in secrecy within a convent after his birth. From childhood he displayed extraordinary courage, humility, and purity of heart. When he arrived at King Arthur's court, he alone was worthy to sit in the mysterious Siege Perilous, a seat at the Round Table said to bring death to any unworthy knight who attempted to occupy it. His successful claim to the seat revealed that he was the knight chosen by destiny.
...
After achieving the Grail Quest, Galahad prayed that his earthly life would end while he remained in God's grace. His wish was granted, and his soul was said to be carried to heaven by angels, making him one of the few Arthurian heroes whose story ends in complete spiritual triumph. Sir Galahad has since become the ultimate symbol of purity, righteousness, selflessness, and the ideal knight whose faith surpassed even the greatest warriors of Camelot.`
  ...
  "BOA-006": {
    ...
    first: "Culhwch and Olwen (c. 1100 AD)",
    period: "Arthurian Era",
    aliases: "Sir Kay; Cai; Cei",
    history: `Sir Kay is one of the oldest and longest-standing Knights of the Round Table, appearing in some of the earliest Arthurian legends. Known as Cai in Welsh tradition, he was introduced long before famous knights such as Lancelot and Galahad were created. In many versions of the legend, Kay is King Arthur's foster brother, having been raised alongside Arthur by Sir Ector. Because of this close bond, Kay remains one of Arthur's most trusted companions throughout his reign.
...
Although later medieval romances often portray Sir Kay as sarcastic, boastful, and quick-tempered, his sharp tongue usually hides a fiercely loyal heart. He frequently challenges younger knights, only for them to prove themselves through courage and honor. Despite his pride and occasional arrogance, Kay never betrays King Arthur and consistently fights to defend Camelot against its enemies. His lifelong loyalty to Arthur and his status as one of the earliest companions of the king have made Sir Kay one of the most enduring figures in Arthurian legend, representing steadfast service, courage, and unwavering loyalty despite his many flaws.`
  ...
  "BOA-007": {
    ...
    first: "Culhwch and Olwen (c. 1100 AD)",
    period: "Arthurian Era",
    aliases: "Sir Lucan; Lucan the Butler; Llwch Llawwynnauc",
    history: `Sir Lucan is one of King Arthur's oldest and most loyal companions, appearing in some of the earliest Arthurian legends. Known in Welsh tradition as Llwch Llawwynnauc, he later became Sir Lucan the Butler in medieval romances. As the royal butler of Camelot, his title referred not to serving food but to holding one of the highest-ranking offices in Arthur's court, responsible for the king's household and often acting as one of his trusted military commanders.

Throughout the Arthurian legends, Lucan is portrayed as a dependable warrior who stands beside Arthur in countless battles. Although he rarely receives adventures of his own like Lancelot or Gawain, he is respected for his courage, loyalty, and unwavering dedication to his king. Alongside his brother Sir Bedivere, Lucan remains one of Arthur's closest companions from the beginning of the kingdom until its tragic end.

Lucan plays his greatest role during the final Battle of Camlann, where Arthur defeats the traitorous Mordred but is mortally wounded. Refusing to abandon his king, Lucan helps carry the injured Arthur from the battlefield alongside Bedivere. Despite being gravely wounded himself, he struggles to lift Arthur to safety until the effort causes his own injuries to become fatal. He dies beside the king he faithfully served for his entire life, making Sir Lucan one of the greatest symbols of loyalty and self-sacrifice in Arthurian legend.`
  },
  ...
  "BOA-008": {
    ...
    first: "Culhwch and Olwen (c. 1100 AD)",
    period: "Arthurian Era",
    aliases: "Sir Gawain; Gwalchmei; Gauvain",
    history: `Sir Gawain is one of the greatest and oldest Knights of the Round Table, appearing in some of the earliest Arthurian legends. In Welsh tradition he is known as Gwalchmei and is described as the nephew of King Arthur, the son of King Lot of Orkney and Arthur's sister Morgause. Renowned for his courtesy, bravery, and loyalty, Gawain became one of the most celebrated heroes of medieval literature and was often considered second only to Sir Lancelot among Arthur's knights.
...
In many Arthurian romances, Gawain possesses a remarkable gift: as the sun rises toward noon, his strength steadily increases until it becomes unmatched at midday before gradually fading again as evening approaches. This supernatural blessing makes him nearly unbeatable in battle during the brightest hours of the day. Throughout the legends, Gawain is remembered as a fearless warrior, a model of knightly courtesy, and one of Camelot's greatest champions. His adventures explore the ideals of courage, humility, loyalty, and the difficult pursuit of true honor.`
  ...
  "BOA-009": {
    ...
    first: "Culhwch and Olwen (c. 1100 AD)",
    period: "Arthurian Era",
    aliases: "Sir Bedivere; Bedwyr; Bedivere the One-Handed",
    history: `Sir Bedivere is one of King Arthur's oldest and most faithful companions, appearing in the earliest Welsh legends as Bedwyr. He is among the very first warriors associated with Arthur and remains by the king's side from the beginning of Camelot until its final moments. In Welsh tradition, Bedwyr is described as an extraordinary warrior, sometimes possessing only one hand, yet so skilled in battle that this disability never hindered his abilities. His courage and unwavering loyalty earned him a permanent place among the Knights of the Round Table.

Throughout Arthurian legend, Bedivere serves as one of Arthur's most trusted knights and closest friends. Although later romances often focus on heroes such as Lancelot, Gawain, and Galahad, Bedivere is consistently portrayed as a dependable warrior who never abandons his king. He fights in countless battles defending Camelot and stands beside Arthur even when the kingdom begins to collapse through betrayal and civil war.

Bedivere's greatest moment comes after the final Battle of Camlann. With Arthur mortally wounded, the king commands Bedivere to return the sacred sword Excalibur to the Lady of the Lake by throwing it into the water. Twice Bedivere cannot bring himself to part with the legendary weapon and secretly hides it instead. On the third attempt, he obeys Arthur's command, watching as a mysterious hand rises from the lake to catch Excalibur before disappearing beneath the water. Soon afterward, Bedivere witnesses Arthur being carried away to the island of Avalon, where the legendary king is said to await his return. Bedivere remains one of the greatest symbols of loyalty, duty, and faithfulness in Arthurian legend.`
  },

  "BOA-010": {
    status: "Legendary Knight (Fictional)",
    origin: "French Arthurian Romance",
    first: "Le Roman de Brut (c. 1155 AD)",
    period: "Arthurian Era",
    aliases: "Sir Sagramore; Sagramore the Desirous",
    history: `Sir Sagremore, is one of the legendary Knights of the Round Table and a renowned warrior in Arthurian legend. He first appears in the 12th-century romances inspired by Geoffrey of Monmouth's histories and soon became a regular member of Arthur's court. Though he is not as famous as Lancelot or Gawain, Sagremore earned a reputation as one of Camelot's fiercest and most fearless champions.
...
"BOA-011": {
    ...
    first: "Lancelot-Grail Cycle (Early 13th Century)",
    period: "Arthurian Era",
    aliases: "Lady of the Lake; Nimue; Viviane; Niniane",
    history: `The Lady of the Lake is one of the most mysterious and powerful figures in Arthurian legend. Rather than a single character, the title "Lady of the Lake" has been given to several magical women throughout medieval romances, though the most famous are Nimue and Viviane. She is portrayed as a powerful enchantress who dwells within a magical lake or hidden kingdom, possessing wisdom and supernatural abilities beyond those of ordinary mortals.

The Lady of the Lake is best known for giving King Arthur the legendary sword Excalibur after the Sword in the Stone is broken. Rising from the waters, she presents Arthur with the enchanted blade, which becomes the symbol of his rightful kingship. Later, when Arthur is mortally wounded at the Battle of Camlann, she receives Excalibur back as Sir Bedivere throws it into the lake, with a mysterious hand rising from the water to catch the sacred weapon before disappearing beneath the surface.

In many later romances, the Lady of the Lake also raises the young Sir Lancelot after the death of his father, earning him the title "Lancelot du Lac," meaning "Lancelot of the Lake." She teaches him courtesy, chivalry, and the skills that make him the greatest knight of Camelot. Some versions also identify her as the woman who learns Merlin's magic before trapping the great wizard forever inside an enchanted cave or tree. Throughout Arthurian legend, the Lady of the Lake represents mystery, magic, wisdom, and the supernatural forces that guide the destiny of King Arthur and Camelot.`
  },

  "BOA-012": {
    status: "Legendary Queen (Fictional)",
    origin: "Welsh and British Arthurian Tradition",
    first: "Culhwch and Olwen (c. 1100 AD)",
    period: "Arthurian Era",
    aliases: "Queen Guinevere; Gwenhwyfar; Guenevere",
    history: `Queen Guinevere is the legendary wife of King Arthur and the Queen of Camelot. She appears in some of the earliest Welsh Arthurian tales as Gwenhwyfar before becoming one of the central figures in medieval romances across Europe. Celebrated for her beauty, grace, and noble bearing, Guinevere became the ideal medieval queen, but her story is also one of love, tragedy, and the downfall of Arthur's kingdom.
...
"BOA-013": {
    status: "Legendary Knight (Fictional)",
    origin: "Welsh and British Arthurian Tradition",
    first: "Annales Cambriae (c. 10th Century)",
    period: "Arthurian Era",
    aliases: "Sir Mordred; Medraut",
    history: `Sir Mordred is the greatest traitor in Arthurian legend and the knight whose betrayal brings about the fall of Camelot. In the earliest Welsh traditions, Medraut is mentioned only briefly and is not necessarily portrayed as evil. However, later medieval romances transformed him into King Arthur's nephew—or, in many versions, Arthur's illegitimate son—and the kingdom's ultimate enemy.

As one of the Knights of the Round Table, Mordred was once trusted by King Arthur. During Arthur's campaigns abroad, Mordred seized the opportunity to claim the throne for himself. Many legends also state that he attempted to marry Queen Guinevere to strengthen his claim as king. His rebellion divided Camelot and forced Arthur to return home for one final confrontation.

The conflict ended at the legendary Battle of Camlann. During the battle, Arthur struck Mordred down with his spear, but Mordred delivered a fatal blow to Arthur before dying. Their deaths marked the end of Camelot and the age of the Round Table. Mordred remains one of the greatest symbols of betrayal, ambition, and the tragic downfall of Arthur's kingdom.`
  },

  "BOA-014": {
    status: "Legendary Knight (Fictional)",
    origin: "French Arthurian Romance",
    first: "Perceval, the Story of the Grail (c. 1180 AD)",
    period: "Arthurian Era",
    aliases: "Sir Percival; Perceval",
    history: `Sir Percival is one of the greatest Knights of the Round Table and one of the original heroes of the Holy Grail legend. He was first introduced by the French poet Chrétien de Troyes, whose unfinished romance Perceval, the Story of the Grail inspired centuries of later Arthurian literature. Percival is remembered for his innocence, courage, and spiritual growth.

Raised in isolation by his mother to keep him from becoming a knight, Percival knew nothing of the outside world until he encountered Arthur's knights. Inspired by their honor and bravery, he journeyed to Camelot and eventually became one of its greatest champions. His kindness and determination helped him overcome many trials despite his lack of experience.

Percival became one of the three knights who successfully pursued the Holy Grail alongside Sir Galahad and Sir Bors. Although early versions of the legend portray Percival as the Grail's primary hero, later romances gave the final achievement to Galahad while Percival remained one of his closest companions. He represents innocence, faith, perseverance, and the lifelong pursuit of wisdom.`
  },
  ...
  "BOA-015": {
    ...
    first: "Lancelot-Grail Cycle (Early 13th Century)",
    period: "Arthurian Era",
    aliases: "Sir Bors; Bors the Younger",
    history: `Sir Bors is one of the greatest Knights of the Round Table and the cousin of Sir Lancelot. Unlike many Arthurian heroes, Bors is remembered not only for his skill in battle but also for his unwavering faith and moral character. He is one of the few knights considered pure enough to participate in the successful quest for the Holy Grail.

During the Grail Quest, Sir Bors faced numerous trials that tested his loyalty, compassion, and devotion to God. While many famous knights failed because of pride or personal weakness, Bors remained steadfast and faithful. Alongside Sir Galahad and Sir Percival, he became one of only three knights to witness the Holy Grail's miracles.

After Galahad's death and Percival's passing, Bors returned to Camelot as the sole survivor of the successful Grail Quest. He continued serving King Arthur until the kingdom's final days. Sir Bors is remembered as the ideal balance between knightly valor and spiritual devotion, representing faith, humility, and unwavering honor.`
  },

  "BOA-016": {
    status: "Legendary Knight (Fictional)",
    origin: "Celtic and French Romance",
    first: "Béroul's Tristan (12th Century)",
    period: "Arthurian Era",
    aliases: "Sir Tristan; Tristram",
    history: `Sir Tristan is one of the greatest knights of Arthurian legend and one of medieval literature's most famous tragic heroes. Although his story existed independently before being woven into the Arthurian cycle, later romances made him one of the finest Knights of the Round Table. He is celebrated as an unmatched swordsman, hunter, and musician.

Tristan is best known for his tragic romance with the Irish princess Isolde. Through fate—or in many versions, by accidentally drinking a magical love potion—the two fell deeply in love despite Isolde being promised to King Mark of Cornwall. Their forbidden relationship led to years of adventure, betrayal, exile, and heartbreak.

Despite his personal struggles, Tristan remained one of Camelot's greatest warriors and was often ranked alongside Lancelot as one of the strongest knights of the Round Table. His story ends tragically with the deaths of both Tristan and Isolde, making them enduring symbols of doomed love, courage, and sacrifice.`
  },
  ...
  "BOA-017": {
    ...
    first: "Lancelot-Grail Cycle (Early 13th Century)",
    period: "Arthurian Era",
    aliases: "Sir Gareth; Gareth Beaumains",
    history: `Sir Gareth is the youngest brother of Sir Gawain and one of the most beloved Knights of the Round Table. Seeking to earn his reputation through merit rather than noble birth, Gareth arrived at Camelot disguised as a common servant. Because of his humble appearance, Sir Kay mockingly nicknamed him "Beaumains," meaning "Fair Hands."

Refusing special treatment, Gareth worked in the royal kitchens before setting out on adventures to prove his worth. He defeated numerous powerful knights, rescued the Lady Lyonesse, and eventually married her. Through courage, humility, and determination, Gareth earned the admiration of King Arthur and the entire Round Table.

Sir Gareth's story ends tragically during the conflict between Lancelot and Arthur. Although Gareth refused to fight against his friend Lancelot, he was accidentally killed during Lancelot's rescue of Queen Guinevere. His death became one of the events that pushed Camelot toward civil war. Gareth remains a symbol of humility, kindness, and honor earned through actions rather than birth.`
  },

  "BOA-018": {
    status: "Legendary Knight (Fictional)",
    origin: "French Arthurian Romance",
    first: "Vulgate Cycle (13th Century)",
    period: "Arthurian Era",
    aliases: "Sir Agravain; Agravaine",
    history: `Sir Agravain is one of King Arthur's Knights of the Round Table and one of the brothers of Sir Gawain, Sir Gareth, and Sir Gaheris. Unlike his honorable siblings, Agravain is often portrayed as suspicious, prideful, and quick to stir conflict. His actions play a major role in the downfall of Camelot.

Agravain becomes convinced that Sir Lancelot and Queen Guinevere are secretly in love. Determined to expose them, he leads a group of knights to catch the pair together. The confrontation results in a violent battle in which Lancelot kills Agravain while escaping. The scandal that follows divides the Round Table and begins the chain of events leading to Arthur's final war.

Although remembered as a controversial figure, Agravain believed he was defending the honor of the king and the laws of Camelot. His actions reveal how loyalty without wisdom can have disastrous consequences. He remains one of Arthurian legend's most complex and tragic characters.`
  },

  "BOA-019": {
    status: "Legendary Knight (Fictional)",
    origin: "Welsh and French Arthurian Tradition",
    first: "Culhwch and Olwen (c. 1100 AD)",
    period: "Arthurian Era",
    aliases: "Sir Gaheris; Gaheris",
    history: `Sir Gaheris is one of the Knights of the Round Table and the younger brother of Sir Gawain, Sir Gareth, and Sir Agravain. Though less famous than his brothers, Gaheris is consistently portrayed as a capable, honorable, and dependable knight who serves King Arthur with loyalty throughout the kingdom's greatest adventures.
