// Worlds Under Siege card database
// Card types were inferred from the current set order and the previous site data.
// You can edit any card's type, name, or image path here without touching cards.html.
...
const cards = [
  ...
  },
  {
    ...
    "backImage": "cards/BOA-033 Mr Hyde.jpg",
    "searchNames": [
      "Dr Jekyl",
      "Mr Hyde",
      "Jekyl",
